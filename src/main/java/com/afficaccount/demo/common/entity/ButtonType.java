...
public class ButtonType {
	 ...
	 public final static String MEDIA_ID = "media_id"; // 跳转到永久素材
	 public final static String VIEW_LIMITED = "view_limited"; //跳转永久图文消息
	 public final static String MINIPROGRAM = "miniprogram"; //跳转小程序
